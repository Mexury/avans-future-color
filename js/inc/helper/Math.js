/** @typedef {{ red: number, green: number, blue: number }} RGBColorObject */
/** @typedef {{ hue: number, saturation: number, lightness: number }} HSLColorObject */
